...
public class MachineController implements Serializable {
    ...
    private services.EmployeFacade employeFacade;
     private List<Machine> machinesForEmployee;
    private Employe selectedEmployee; // Add a field to store the selected employee ID
    ...
    public List<Machine> getMachinesForEmployee() {
        return machinesForEmployee;
    }

    public void setMachinesForEmployee(List<Machine> machinesForEmployee) {
        this.machinesForEmployee = machinesForEmployee;
    }
   ...
   public List<Machine> loadMachinesForEmployee() {
        machinesForEmployee=  ejbFacade.getMachinesForEmployee(selectedEmployee);
        return machinesForEmployee;
    ...
    private void createChartModel() {
        ...
        Map<Integer, Long> data = ejbFacade.getMachinesCountByYear();

        ChartSeries series = new ChartSeries();
        series.setLabel("Machines acquises par année");

        for (Map.Entry<Integer, Long> entry : data.entrySet()) {
            series.set(entry.getKey().toString(), entry.getValue());
        }
